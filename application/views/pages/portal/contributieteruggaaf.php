...
<div class="row" >
    ...
    <div class="col-md-3">
        ...
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="<?= base_url('/ledenportaal/dossiers'); ?>">Dossier overzicht</a></li>
            <li class="active"><a href="<?= base_url('/ledenportaal/contributieteruggaaf'); ?>">Contributieteruggaaf</a></li>
        </ul>
    </div>

    <div class="col-lg-9" >
        <h1>Webportaal Contributieteruggaaf</h1>
        ...
        <a href="<?= base_url('/ledenportaal/contributieteruggaaf/downloadsecurefile/' . $downloadId); ?>" target="_blank" >Download uw teruggaaf formulier</a>
    </div>
</div>